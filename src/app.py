...
activities = {
    ...
    "Track and Field": {
        "description": "Running, jumping, and throwing events for athletes",
    ...
    "Drama Club": {
        "description": "Theater production with acting, directing, and stage design",
    ...
    "Debate Team": {
        ...
        "max_participants": 14,
        "participants": ["aisha@mergington.edu", "chris@mergington.edu"]
    }
}
